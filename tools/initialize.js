...
(async () => {
    ...
    execSync('dotnet ef migrations add Article --context CmsDbContext');
    execSync('dotnet ef database update --context CmsDbContext');
    console.log('initialize cms api finish');
})();
